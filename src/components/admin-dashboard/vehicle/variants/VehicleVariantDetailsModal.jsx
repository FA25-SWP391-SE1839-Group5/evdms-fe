...
export default function VehicleVariantDetailsModal({ show, onClose, variantId, modelsMap }) {
    ...
    if (show && variantId) {
      const fetchVariantDetails = async () => {
        ...
        try {
          ...
          setError(err + "Failed to load vehicle variant details.");
        } finally {
          setLoading(false);
        }
      };
              ...
              {variant && !loading && (
                <div>
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <strong>Model:</strong> {modelsMap[variant.modelId] || "N/A"}
                    </li>
                    <li>
                      <strong>Variant Name:</strong> {variant.name || "N/A"}
                    </li>
                    <li>
                      <strong>Base Price:</strong> {formatCurrency(variant.basePrice)}
                    </li>
                  </ul>
                  <hr />
