const VehicleVariantHeader = ({ onRefresh, totalResults }) => (
  <div className="d-flex justify-content-between align-items-center mb-4">
    <div>
      <h4 className="fw-bold mb-1">Vehicle Variant Browsing</h4>
      <p className="text-muted mb-0">Browse vehicle variants</p>
    </div>
    <div>
