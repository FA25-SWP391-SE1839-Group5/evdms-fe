...
import { exportVariantOrderRates, getVariantOrderRates } from "../../../services/reportService";
...
const VariantOrderRates = () => {
  ...
  const handleExport = async () => {
    try {
      await exportVariantOrderRates("csv", { page, pageSize, sortBy, sortOrder });
    } catch {
      alert("Export failed");
    }
  };
            ...
            <div className="table-responsive">
              <table className="table table-hover">
                <thead>
                  <tr>
                    <th>#</th>
                    <th onClick={() => handleSort("variantName")} style={{ cursor: "pointer" }}>
                      Variant Name {sortBy === "variantName" && (sortOrder === "asc" ? "▲" : "▼")}
                    </th>
                    <th onClick={() => handleSort("orderCount")} style={{ cursor: "pointer" }}>
                      Order Count {sortBy === "orderCount" && (sortOrder === "asc" ? "▲" : "▼")}
                    </th>
...
export default VariantOrderRates;
