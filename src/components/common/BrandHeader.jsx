    ...
    <div className="mb-8">
      <div className="flex items-center mb-6">
        <div className="flex items-center justify-center w-18 h-16">
          <img src="/assets/images/elecar_logo.svg" alt="Logo" className="w-18 h-18 object-cover rounded-xl" />
        </div>
        <div>
          <h1 className="text-4xl font-bold text-gray-800 mb-2">EVDMS</h1>
          <p className="text-lg text-gray-700 mt-1 font-medium">Electric Vehicle Dealer Management System</p>
        </div>
      </div>
